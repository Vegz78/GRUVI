...
if (PHP_SAPI === 'cli') {	//Only valid for command line, not web
	...
	//The help screen output
		...
		echo "php gruvi.php Touch                        -Produces images for the Squeezebox Touch with" . PHP_EOL;
		echo "                                            settings set insidethe gruvi.php script file" . PHP_EOL . PHP_EOL;
		...
		echo "http://192.168.0.1/gruvi.php               -Produces image list directly with images for the" . PHP_EOL;
		echo "                                            SB Radio with settings set inside the gruvi.php" . PHP_EOL;
		echo "                                            script file" . PHP_EOL;
		echo "http://192.168.0.1/gruvi.php?player=Touch  -Produces image list directly with images for the" . PHP_EOL;
		echo "                                            SB Touch with settings set inside the gruvi.php" . PHP_EOL;
		echo "http://192.168.0.1/gruvi.php?player=Custom -Produces image list directly with images for a" . PHP_EOL;
		...
		echo "http://192.168.0.1:9000/html/sbradio.txt   -Image list directly to images for the SB Radio" . PHP_EOL;
		echo "                                            with settings set inside the gruvi.php script" . PHP_EOL;
		echo "http://192.168.0.1:9000/html/sbtouch.txt   -Image list directly to images for the SB Touch" . PHP_EOL;
		echo "                                            with settings set inside the gruvi.php script" . PHP_EOL . PHP_EOL;
